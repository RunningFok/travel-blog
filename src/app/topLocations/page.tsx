    ...
    <main id="top"  className="px-10 leading-7 bg-neutral-100 text-wh-900">
      <div className="py-10 ml-5 lg:ml-80 flex flex-col">
        <Image
          width={700}
          height={700}
          src={".next/static/media/bestThings.jpg"}
          alt={""}
        />
      ...
      <Top10Post
        ...
        image={".next/static/media/cc1.jpg"}
      ...
      <Top10Post
        ...
        image={".next/static/media/cc2.jpg"}
        categoryTag="Attractions"
        locationTag="North"
      ...
      <Top10Post
        ...
        image={".next/static/media/cc3.jpeg"}
        categoryTag="Temple"
        locationTag="North"
      ...
      <Top10Post
        ...
        image={".next/static/media/cc4.jpg"}
      ...
      <Top10Post
        ...
        image={".next/static/media/cc5.jpeg"}
        categoryTag="Scenic"
        locationTag="South"
      ...
      <Top10Post
        ...
        image={".next/static/media/cc6.jpg"}
        categoryTag="Scenic"
        locationTag="East"
      ...
      <Top10Post
        ...
        image={".next/static/media/cc8.jpg"}
        categoryTag="Hiking"
        locationTag="Scenic"
      ...
      <Top10Post
        ...
        image={".next/static/media/cc10.jpg"}
        categoryTag="Scenic"
        locationTag="North"

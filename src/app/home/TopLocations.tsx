...
export default function TopLocations() {
  return (
    <section className="pt-3 md:pb-28 lg:pb-28">
      <div className="sm:grid sm:gap-0 md:grid-cols-5 md:grid-rows-3 lg:grid-cols-5 lg:grid-rows-3 sm:h-[400px] mx-0 my-3 w-11/12">
        <TopPostCard

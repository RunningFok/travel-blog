  ...
  return (
    <section className="pb-10">
      ...
      <div className="lg:ml-96 lg:mr-96 relative py-5 md:grid md:grid-cols-2 lg:grid lg:grid-cols-2 gap-3 justify-center items-stretch content-evenly ">
        <Post
          image="/static/images/bunfestival2.jpg"
        ...
        />
        <Post
          image="/static/images/windsurfing3.jpg"
        ...
        />
        <Post
          image="/static/images/musicfestival.jpeg"
        ...
        />
        <Post
          image="/static/images/adventurecamping.jpeg"

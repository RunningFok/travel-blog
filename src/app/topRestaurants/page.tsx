    ...
    <main id="top" className="px-10 leading-7 bg-neutral-100 text-wh-900">
      <div className="py-10 ml-5 lg:ml-80 flex flex-col">
        <Image
          width={700}
          height={700}
          src={".next/static/media/buns.jpeg"}
          alt={""}
        />
      ...
      <Top10Post
        ...
        image={".next/static/media/restaurant1.jpg"}
      ...
      <Top10Post
        ...
        image={".next/static/media/restaurant2.jpg"}
        categoryTag="Attractions"
        locationTag="North"
      ...
      <Top10Post
        ...
        image={".next/static/media/restaurant3.jpg"}
        categoryTag="Temple"
        locationTag="North"
      ...
      <Top10Post
        ...
        image={".next/static/media/restaurant4.jpg"}
      ...
      <Top10Post
        ...
        image={".next/static/media/restaurant5.jpg"}
        categoryTag="Scenic"
        locationTag="South"
